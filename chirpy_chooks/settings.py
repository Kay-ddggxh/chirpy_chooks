"""
Django settings for chirpy_chooks project.
...
ROOT_URLCONF = 'chirpy_chooks.urls'
...
WSGI_APPLICATION = 'chirpy_chooks.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'chirpy-chooks'
